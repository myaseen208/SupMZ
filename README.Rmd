...
###### Version : [`r getNamespaceVersion("binGroup2")`](https://myaseen208.github.io/binGroup2/); Copyright (C) 2019-2022: [UNL](https://statistics.unl.edu/); License: [GPL-2|GPL-3](https://www.r-project.org/Licenses/)


##### *Brianna Hitt^1^, Christopher Bilder^2^, Frank Schaarschmidt^3^, Brad Biggerstaff, Christopher McMahan,  Joshua Tebbs, Boan Zhang, Michael Black, Peijie Hou,  and Peng Chen*
...
```{r, echo = FALSE, eval=TRUE}
detach("package:binGroup2", unload=TRUE)
suppressPackageStartupMessages(library(binGroup2))
cit <- citation("binGroup2")
